...
public class CameraInteraction extends SimpleInteraction {
   ...
   public static CameraActionType getCameraAction(MemorySegment mem, int offset) {
      return CameraActionType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 19));
   }
   ...
   public static CameraPerspectiveType getCameraPerspective(MemorySegment mem, int offset) {
      return CameraPerspectiveType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 20));
   }
   ...
   public static CameraInteraction toObject(MemorySegment mem, int offset) {
      ...
      return new CameraInteraction(
         ...
         CameraActionType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 19)),
         CameraPerspectiveType.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 20)),
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_BYTE, offset + 19, (byte)this.cameraAction.getValue());
      mem.set(PacketIO.PROTO_BYTE, offset + 20, (byte)this.cameraPerspective.getValue());
      mem.set(PacketIO.PROTO_BOOL, offset + 21, this.cameraPersist);
      mem.set(PacketIO.PROTO_FLOAT, offset + 22, this.cameraInteractionTime);
