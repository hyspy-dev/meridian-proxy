...
public class ItemWeapon {
   ...
   public static ItemWeapon toObject(MemorySegment mem, int offset) {
      ...
      return new ItemWeapon(
         ...
         hasUltimateDamageBreakdown(mem, offset) ? DamageData.toObject(mem, offset + getValidatedOffset(mem, offset, 14, 18, "UltimateDamageBreakdown")) : null
      );
   }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits & 2) != 0) {
         ...
         int pos = offset + 18 + statModifiersOffset;
      ...
      if ((nullBits & 4) != 0) {
         ...
         int pos = offset + 18 + basicDamageBreakdownOffset;
         ValidationResult basicDamageBreakdownResult = DamageData.validateStructure(buffer, pos);
         ...
         pos += DamageData.computeBytesConsumed(buffer, pos);
      }
      ...
      if ((nullBits & 8) != 0) {
         ...
         int pos = offset + 18 + ultimateDamageBreakdownOffset;
         ValidationResult ultimateDamageBreakdownResult = DamageData.validateStructure(buffer, pos);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof ItemWeapon other)
            ? false
