...
public class ResetCooldownInteraction extends SimpleInteraction {
   ...
   public static ResetCooldownInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 43) {
         throw ProtocolException.bufferTooSmall("ResetCooldownInteraction", 43, buf.readableBytes() - offset);
      }
   ...
   public static ResetCooldownInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 43 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("ResetCooldownInteraction", offset + 43, (int)mem.byteSize());
      }
      ...
      return new ResetCooldownInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof ResetCooldownInteraction other)
            ? false
