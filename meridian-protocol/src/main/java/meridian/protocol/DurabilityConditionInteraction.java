...
public class DurabilityConditionInteraction extends SimpleInteraction {
   ...
   @Nonnull
   public DurabilityOperator operator = DurabilityOperator.LessThan;
   ...
   public DurabilityConditionInteraction(
      ...
      @Nonnull DurabilityOperator operator
   ) {
   ...
   @Nonnull
   public static DurabilityConditionInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 45) {
         throw ProtocolException.bufferTooSmall("DurabilityConditionInteraction", 45, buf.readableBytes() - offset);
      }

      DurabilityConditionInteraction obj = new DurabilityConditionInteraction();
      ...
      obj.threshold = buf.getFloatLE(offset + 19);
      obj.valueType = ValueType.fromValue(buf.getByte(offset + 23));
      obj.operator = DurabilityOperator.fromValue(buf.getByte(offset + 24));
      if ((nullBits & 1) != 0) {
   ...
   public static InteractionEffects getEffects(MemorySegment mem, int offset) {
      return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 25, 45, "Effects")) : null;
   }
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 29, 45, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 33, 45, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 37, 45, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
      return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 41, 45, "Camera")) : null;
   }
   ...
   public static DurabilityOperator getOperator(MemorySegment mem, int offset) {
      return DurabilityOperator.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 24));
   }
   ...
   public static DurabilityConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 45 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("DurabilityConditionInteraction", offset + 45, (int)mem.byteSize());
      }
      ...
      return new DurabilityConditionInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 25, 45, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 33, 45, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 41, 45, "Camera")) : null,
         ...
         DurabilityOperator.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 24))
      );
   }
   ...
   public int serialize(@Nonnull ByteBuf buf) {
      ...
      buf.writeByte(this.operator.getValue());
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, offset + 19, this.threshold);
      mem.set(PacketIO.PROTO_BYTE, offset + 23, (byte)this.valueType.getValue());
      mem.set(PacketIO.PROTO_BYTE, offset + 24, (byte)this.operator.getValue());
      int varOffset = offset + 45;
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, offset + 25, varOffset - offset - 45);
      ...
      if (this.settings != null) {
         mem.set(PacketIO.PROTO_INT, offset + 29, varOffset - offset - 45);
         if (this.settings.size() > 4096000) {
            throw ProtocolException.dictionaryTooLarge("Settings", this.settings.size(), 4096000);
         }
      ...
      if (this.rules != null) {
         mem.set(PacketIO.PROTO_INT, offset + 33, varOffset - offset - 45);
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if (v >= 6) {
         return ValidationResult.error("Invalid DurabilityOperator value for Operator");
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof DurabilityConditionInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      result = 31 * result + Float.hashCode(this.threshold);
      result = 31 * result + Objects.hashCode(this.valueType);
      return 31 * result + Objects.hashCode(this.operator);
   }
}
