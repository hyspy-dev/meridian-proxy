...
public class UseEntityInteraction extends SimpleInteraction {
   ...
   public static UseEntityInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 39) {
         throw ProtocolException.bufferTooSmall("UseEntityInteraction", 39, buf.readableBytes() - offset);
      }
   ...
   public static UseEntityInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 39 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("UseEntityInteraction", offset + 39, (int)mem.byteSize());
      }
      ...
      return new UseEntityInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof UseEntityInteraction other)
            ? false
