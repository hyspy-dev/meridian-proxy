...
public class PickBlockInteraction extends SimpleBlockInteraction {
   ...
   public static PickBlockInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 40) {
         throw ProtocolException.bufferTooSmall("PickBlockInteraction", 40, buf.readableBytes() - offset);
      }
   ...
   public static PickBlockInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 40 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("PickBlockInteraction", offset + 40, (int)mem.byteSize());
      }
      ...
      return new PickBlockInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof PickBlockInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Boolean.hashCode(this.useLatestTarget);
   }
}
