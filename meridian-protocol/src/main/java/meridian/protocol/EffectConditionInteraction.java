...
public class EffectConditionInteraction extends SimpleInteraction {
   ...
   public static InteractionEffects getEffects(MemorySegment mem, int offset) {
      return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 21, 45, "Effects")) : null;
   }
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 25, 45, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 29, 45, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 33, 45, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
      return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 37, 45, "Camera")) : null;
   }
   ...
   public static int[] getEntityEffects(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 41, 45, "EntityEffects");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
      ...
      if (len > 4096000) {
         throw ProtocolException.arrayTooLong("EntityEffects", len, 4096000);
      }

      int lenOffset = (int)(packed >>> 32);
      if (off + lenOffset + len * 4L > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("EntityEffects", off + lenOffset + len * 4, (int)mem.byteSize());
      }
   ...
   public static Match getMatch(MemorySegment mem, int offset) {
      return Match.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 19));
   }
   ...
   public static InteractionTarget getEntityTarget(MemorySegment mem, int offset) {
      return InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 20));
   }
   ...
   public static EffectConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 45 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("EffectConditionInteraction", offset + 45, (int)mem.byteSize());
      }
      ...
      if (hasEntityEffects(mem, offset)) {
         ...
         off += lenOffset;
         entityEffects = new int[len];
         MemorySegment.copy(mem, PacketIO.PROTO_INT, off, entityEffects, 0, len);
      }

      return new EffectConditionInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 21, 45, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 29, 45, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 37, 45, "Camera")) : null,
         mem.get(PacketIO.PROTO_INT, offset + 11),
         mem.get(PacketIO.PROTO_INT, offset + 15),
         entityEffects,
         Match.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 19)),
         InteractionTarget.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 20))
      );
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_BYTE, offset + 19, (byte)this.match.getValue());
      mem.set(PacketIO.PROTO_BYTE, offset + 20, (byte)this.entityTarget.getValue());
      int varOffset = offset + 45;
      if (this.effects != null) {
         mem.set(PacketIO.PROTO_INT, offset + 21, varOffset - offset - 45);
