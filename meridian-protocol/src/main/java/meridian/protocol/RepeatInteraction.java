...
public class RepeatInteraction extends SimpleInteraction {
   ...
   public static RepeatInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 47) {
         throw ProtocolException.bufferTooSmall("RepeatInteraction", 47, buf.readableBytes() - offset);
      }
      ...
      if ((nullBits & 4) != 0) {
         int varPosBase2 = buf.getIntLE(offset + 35);
      ...
      if ((nullBits & 8) != 0) {
         int varPosBase3 = buf.getIntLE(offset + 39);
      ...
      if ((nullBits & 16) != 0) {
         int varPosBase4 = buf.getIntLE(offset + 43);
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 31, 47, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 35, 47, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 39, 47, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static RepeatInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 47 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("RepeatInteraction", offset + 47, (int)mem.byteSize());
      }
      ...
      return new RepeatInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 27, 47, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 35, 47, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 43, 47, "Camera")) : null,
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_INT, offset + 19, this.forkInteractions);
      mem.set(PacketIO.PROTO_INT, offset + 23, this.repeat);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof RepeatInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Integer.hashCode(this.repeat);
   }
}
