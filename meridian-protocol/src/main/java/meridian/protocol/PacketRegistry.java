...
import meridian.protocol.packets.assets.UpdateAudioStates;
...
import meridian.protocol.packets.assets.UpdateMusicContainers;
...
import meridian.protocol.packets.assets.UpdatePhysicalMaterials;
...
import meridian.protocol.packets.buildertools.BuilderToolPrefabPreview;
import meridian.protocol.packets.buildertools.BuilderToolRandomizeClipboard;
...
import meridian.protocol.packets.connection.InsecurePlayerOptions;
import meridian.protocol.packets.connection.Ping;
import meridian.protocol.packets.connection.Pong;
import meridian.protocol.packets.connection.RequestInsecurePlayerOptions;
...
import meridian.protocol.packets.interface_.ArgCacheInvalidation;
import meridian.protocol.packets.interface_.ArgValuesRequest;
import meridian.protocol.packets.interface_.ArgValuesResponse;
import meridian.protocol.packets.interface_.ChatMessage;
import meridian.protocol.packets.interface_.CommandSuggestionsRequest;
import meridian.protocol.packets.interface_.CommandSuggestionsResponse;
import meridian.protocol.packets.interface_.CommandTreeSync;
...
import meridian.protocol.packets.interface_.ExecuteServersidePageCommand;
...
import meridian.protocol.packets.interface_.UpdateServersideUIPage;
...
import meridian.protocol.packets.player.SelectionToolShowTriggerVolumes;
...
import meridian.protocol.packets.player.TriggerVolumeToolDelete;
import meridian.protocol.packets.player.TriggerVolumeToolDuplicate;
import meridian.protocol.packets.player.TriggerVolumeToolEquip;
import meridian.protocol.packets.player.TriggerVolumeToolGroupCreate;
import meridian.protocol.packets.player.TriggerVolumeToolGroupCreateResponse;
import meridian.protocol.packets.player.TriggerVolumeToolGroupMove;
import meridian.protocol.packets.player.TriggerVolumeToolMove;
...
import meridian.protocol.packets.setup.SetupFinalize;
...
import meridian.protocol.packets.world.SetAudioState;
...
import meridian.protocol.packets.world.UpdateForcedMusic;
...
public final class PacketRegistry {
   ...
   static {
      ...
      register(
         ...
         89,
         "UpdateAudioStates",
         UpdateAudioStates.class,
         6,
         1677721600,
         true,
         UpdateAudioStates::validateStructure,
         UpdateAudioStates::deserialize,
         UpdateAudioStates::toObject
      );
      register(
         PacketRegistry.PacketDirection.ToClient,
         NetworkChannel.Default,
      ...
      register(
         ...
         24,
         false,
         SetAudioState::validateStructure,
         SetAudioState::deserialize,
         SetAudioState::toObject
      );
      register(
         PacketRegistry.PacketDirection.ToClient,
         NetworkChannel.Default,
      ...
      register(
         ...
         NetworkChannel.Default,
         428,
         "BuilderToolRandomizeClipboard",
         BuilderToolRandomizeClipboard.class,
         15,
         15,
         false,
         BuilderToolRandomizeClipboard::validateStructure,
         BuilderToolRandomizeClipboard::deserialize,
         BuilderToolRandomizeClipboard::toObject
      );
      register(
         PacketRegistry.PacketDirection.ToClient,
         NetworkChannel.Default,
         429,
         "BuilderToolPrefabPreview",
         BuilderToolPrefabPreview.class,
         21,
         1677721600,
         true,
      ...
      register(
         ...
         NetworkChannel.Default,
         504,
         "TriggerVolumeToolSetCancelDelayedOnExit",
         TriggerVolumeToolSetCancelDelayedOnExit.class,
         1,
         16384006,
         false,
         TriggerVolumeToolSetCancelDelayedOnExit::validateStructure,
         TriggerVolumeToolSetCancelDelayedOnExit::deserialize,
         TriggerVolumeToolSetCancelDelayedOnExit::toObject
      );
      register(
         PacketRegistry.PacketDirection.ToServer,
         NetworkChannel.Default,
         ...
         TriggerVolumeToolDuplicate.class,
         0,
         1677721600,
         false,
