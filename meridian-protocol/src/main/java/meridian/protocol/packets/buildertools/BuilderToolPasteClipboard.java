...
public class BuilderToolPasteClipboard implements Packet, ToServerPacket {
   ...
   public static BuilderToolPasteClipboard deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 12) {
         throw ProtocolException.bufferTooSmall("BuilderToolPasteClipboard", 12, buf.readableBytes() - offset);
      }
   ...
   public static BuilderToolPasteClipboard toObject(MemorySegment mem, int offset) {
      if (offset + 12 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("BuilderToolPasteClipboard", offset + 12, (int)mem.byteSize());
      } else {
         return new BuilderToolPasteClipboard(
