...
public class BuilderToolStringArg {
   ...
   public static BuilderToolStringArg deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 1) {
         throw ProtocolException.bufferTooSmall("BuilderToolStringArg", 1, buf.readableBytes() - offset);
      }
   ...
   public static BuilderToolStringArg toObject(MemorySegment mem, int offset) {
      if (offset + 1 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("BuilderToolStringArg", offset + 1, (int)mem.byteSize());
      } else {
         return new BuilderToolStringArg(hasDefault(mem, offset) ? PacketIO.readVarString("Default", mem, offset + 1, 4096000, PacketIO.UTF8) : null);
      }
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof BuilderToolStringArg other ? Objects.equals(this.defaultValue, other.defaultValue) : false;
      }
   }
