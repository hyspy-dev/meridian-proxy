...
public class UISByteDataValue extends UIDataValue {
   ...
   @Nonnull
   public static UISByteDataValue deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 1) {
         throw ProtocolException.bufferTooSmall("UISByteDataValue", 1, buf.readableBytes() - offset);
      }

      UISByteDataValue obj = new UISByteDataValue();
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof UISByteDataValue other ? this.value == other.value : false;
      }
   }
