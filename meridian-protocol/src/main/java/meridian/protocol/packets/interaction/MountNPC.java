...
public class MountNPC implements Packet, ToClientPacket {
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      mem.set(PacketIO.PROTO_FLOAT, offset + 0, this.anchorX);
      mem.set(PacketIO.PROTO_FLOAT, offset + 4, this.anchorY);
      mem.set(PacketIO.PROTO_FLOAT, offset + 8, this.anchorZ);
