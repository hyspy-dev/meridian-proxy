...
public class UseBlockInteraction extends SimpleBlockInteraction {
   ...
   public static UseBlockInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 40) {
         throw ProtocolException.bufferTooSmall("UseBlockInteraction", 40, buf.readableBytes() - offset);
      }
   ...
   public static UseBlockInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 40 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("UseBlockInteraction", offset + 40, (int)mem.byteSize());
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof UseBlockInteraction other)
            ? false
