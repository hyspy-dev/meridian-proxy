...
/**
 * Session lifecycle phase, advanced as well-known trigger packets pass through
 * the pipeline. Modules read the current phase via {@link ProxySession#phase()}
 * to gate behaviour by lifecycle stage.
 *
