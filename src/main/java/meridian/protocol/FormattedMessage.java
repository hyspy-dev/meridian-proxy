...
import meridian.protocol.FormattedMessageImage;
import meridian.protocol.MaybeBool;
...
public class FormattedMessage {
    ...
    public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 0x80) != 0) {
            ...
            if ((pos7 += FormattedMessageImage.computeBytesConsumed(buf, pos7)) - offset > maxEnd) {
                maxEnd = pos7 - offset;
            }
        }
        return maxEnd;
    ...
    public void serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.messageParams != null) {
            ...
            for (var entry : this.messageParams.entrySet()) {
                PacketIO.writeVarString(buf, (String)entry.getKey(), 4096000);
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 0x10) != 0) {
            ...
            pos = offset + 38 + messageParamsOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public FormattedMessage clone() {
        ...
        if (this.messageParams != null) {
            ...
            for (var e2 : this.messageParams.entrySet()) {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(this.image);
        return result;
    }
}
