...
import meridian.protocol.ItemHudUIType;
...
public class ItemHudUI {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ItemHudUI)) {
            return false;
        }
        ItemHudUI other = (ItemHudUI)obj;
        return Objects.equals(this.path, other.path) && Objects.equals((Object)this.type, (Object)other.type);
    }

    public int hashCode() {
        return Objects.hash(new Object[]{this.path, this.type});
    }
}
