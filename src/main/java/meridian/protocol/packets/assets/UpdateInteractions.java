...
ToClientPacket {
    ...
    public static UpdateInteractions deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.interactions = new HashMap<Integer, Interaction>(interactionsCount);
            for (int i = 0; i < interactionsCount; ++i) {
                int key = buf.getIntLE(pos);
                Interaction val = Interaction.deserialize(buf, pos += 4);
    ...
    public int computeSize() {
        ...
        if (this.interactions != null) {
            ...
            for (var kvp : this.interactions.entrySet()) {
    ...
    public UpdateInteractions clone() {
        ...
        copy.interactions = this.interactions != null ? new HashMap<Integer, Interaction>(this.interactions) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateInteractions)) {
            return false;
        }
