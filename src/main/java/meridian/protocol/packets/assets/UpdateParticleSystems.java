...
public class UpdateParticleSystems
implements Packet,
ToClientPacket {
    ...
    public static UpdateParticleSystems deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.particleSystems = new HashMap<String, ParticleSystem>(particleSystemsCount);
            int dictPos = varPos0 + varIntLen;
            for (i = 0; i < particleSystemsCount; ++i) {
                ...
                ParticleSystem val = ParticleSystem.deserialize(buf, dictPos += keyVarLen + keyLen);
                dictPos += ParticleSystem.computeBytesConsumed(buf, dictPos);
                if (obj.particleSystems.put(key, val) == null) continue;
        ...
        if ((nullBits & 2) != 0) {
            ...
            for (i = 0; i < removedParticleSystemsCount; ++i) {
    ...
    public int computeSize() {
        ...
        if (this.particleSystems != null) {
            ...
            for (var entry : this.particleSystems.entrySet()) {
                particleSystemsSize += PacketIO.stringSize((String)entry.getKey()) + ((ParticleSystem)entry.getValue()).computeSize();
            }
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            pos = offset + 10 + particleSystemsOffset;
        ...
        if ((nullBits & 2) != 0) {
            ...
            pos = offset + 10 + removedParticleSystemsOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public UpdateParticleSystems clone() {
        ...
        copy.type = this.type;
        if (this.particleSystems != null) {
            HashMap<String, ParticleSystem> m = new HashMap<String, ParticleSystem>();
            for (var e : this.particleSystems.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateParticleSystems)) {
            return false;
        }
        UpdateParticleSystems other = (UpdateParticleSystems)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.particleSystems, other.particleSystems) && Arrays.equals(this.removedParticleSystems, other.removedParticleSystems);
    }
