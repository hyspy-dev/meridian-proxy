...
public class UpdateItemPlayerAnimations
implements Packet,
ToClientPacket {
    ...
    public static UpdateItemPlayerAnimations deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.itemPlayerAnimations = new HashMap<String, ItemPlayerAnimations>(itemPlayerAnimationsCount);
            for (int i = 0; i < itemPlayerAnimationsCount; ++i) {
                ...
                ItemPlayerAnimations val = ItemPlayerAnimations.deserialize(buf, pos += keyVarLen + keyLen);
                pos += ItemPlayerAnimations.computeBytesConsumed(buf, pos);
                if (obj.itemPlayerAnimations.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.itemPlayerAnimations != null) {
            ...
            for (var kvp : this.itemPlayerAnimations.entrySet()) {
    ...
    public UpdateItemPlayerAnimations clone() {
        ...
        copy.type = this.type;
        if (this.itemPlayerAnimations != null) {
            HashMap<String, ItemPlayerAnimations> m = new HashMap<String, ItemPlayerAnimations>();
            for (var e : this.itemPlayerAnimations.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateItemPlayerAnimations)) {
            return false;
        }
        UpdateItemPlayerAnimations other = (UpdateItemPlayerAnimations)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.itemPlayerAnimations, other.itemPlayerAnimations);
    }
