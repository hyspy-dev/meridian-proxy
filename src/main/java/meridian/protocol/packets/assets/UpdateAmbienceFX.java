...
ToClientPacket {
    ...
    public static UpdateAmbienceFX deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.ambienceFX = new HashMap<Integer, AmbienceFX>(ambienceFXCount);
            for (int i = 0; i < ambienceFXCount; ++i) {
                int key = buf.getIntLE(pos);
                AmbienceFX val = AmbienceFX.deserialize(buf, pos += 4);
                pos += AmbienceFX.computeBytesConsumed(buf, pos);
                if (obj.ambienceFX.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.ambienceFX != null) {
            ...
            for (var kvp : this.ambienceFX.entrySet()) {
    ...
    public UpdateAmbienceFX clone() {
        ...
        if (this.ambienceFX != null) {
            HashMap<Integer, AmbienceFX> m = new HashMap<Integer, AmbienceFX>();
            for (var e : this.ambienceFX.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateAmbienceFX)) {
            return false;
        }
        UpdateAmbienceFX other = (UpdateAmbienceFX)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && this.maxId == other.maxId && Objects.equals(this.ambienceFX, other.ambienceFX);
    }
