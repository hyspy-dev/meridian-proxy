...
ToClientPacket {
    ...
    public static UpdateBlockSets deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.blockSets = new HashMap<String, BlockSet>(blockSetsCount);
            for (int i = 0; i < blockSetsCount; ++i) {
                ...
                BlockSet val = BlockSet.deserialize(buf, pos += keyVarLen + keyLen);
                pos += BlockSet.computeBytesConsumed(buf, pos);
                if (obj.blockSets.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.blockSets != null) {
            int blockSetsSize = 0;
            for (var kvp : this.blockSets.entrySet()) {
    ...
    public UpdateBlockSets clone() {
        ...
        copy.type = this.type;
        if (this.blockSets != null) {
            HashMap<String, BlockSet> m = new HashMap<String, BlockSet>();
            for (var e : this.blockSets.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateBlockSets)) {
            return false;
        }
        UpdateBlockSets other = (UpdateBlockSets)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.blockSets, other.blockSets);
    }
