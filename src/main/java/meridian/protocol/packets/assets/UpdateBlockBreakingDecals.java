...
public class UpdateBlockBreakingDecals
implements Packet,
ToClientPacket {
    ...
    public static UpdateBlockBreakingDecals deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.blockBreakingDecals = new HashMap<String, BlockBreakingDecal>(blockBreakingDecalsCount);
            for (int i = 0; i < blockBreakingDecalsCount; ++i) {
                ...
                BlockBreakingDecal val = BlockBreakingDecal.deserialize(buf, pos += keyVarLen + keyLen);
                pos += BlockBreakingDecal.computeBytesConsumed(buf, pos);
                if (obj.blockBreakingDecals.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.blockBreakingDecals != null) {
            ...
            for (var kvp : this.blockBreakingDecals.entrySet()) {
    ...
    public UpdateBlockBreakingDecals clone() {
        ...
        copy.type = this.type;
        if (this.blockBreakingDecals != null) {
            HashMap<String, BlockBreakingDecal> m = new HashMap<String, BlockBreakingDecal>();
            for (var e : this.blockBreakingDecals.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateBlockBreakingDecals)) {
            return false;
        }
        UpdateBlockBreakingDecals other = (UpdateBlockBreakingDecals)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.blockBreakingDecals, other.blockBreakingDecals);
    }
