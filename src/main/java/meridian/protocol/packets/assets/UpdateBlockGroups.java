...
public class UpdateBlockGroups
implements Packet,
ToClientPacket {
    ...
    public static UpdateBlockGroups deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.groups = new HashMap<String, BlockGroup>(groupsCount);
            for (int i = 0; i < groupsCount; ++i) {
                ...
                BlockGroup val = BlockGroup.deserialize(buf, pos += keyVarLen + keyLen);
                pos += BlockGroup.computeBytesConsumed(buf, pos);
                if (obj.groups.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.groups != null) {
            int groupsSize = 0;
            for (var kvp : this.groups.entrySet()) {
    ...
    public UpdateBlockGroups clone() {
        ...
        copy.type = this.type;
        if (this.groups != null) {
            HashMap<String, BlockGroup> m = new HashMap<String, BlockGroup>();
            for (var e : this.groups.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateBlockGroups)) {
            return false;
        }
        UpdateBlockGroups other = (UpdateBlockGroups)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.groups, other.groups);
    }
