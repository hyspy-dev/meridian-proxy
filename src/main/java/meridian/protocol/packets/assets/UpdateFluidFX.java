...
ToClientPacket {
    ...
    public static UpdateFluidFX deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.fluidFX = new HashMap<Integer, FluidFX>(fluidFXCount);
            for (int i = 0; i < fluidFXCount; ++i) {
                int key = buf.getIntLE(pos);
                FluidFX val = FluidFX.deserialize(buf, pos += 4);
                pos += FluidFX.computeBytesConsumed(buf, pos);
                if (obj.fluidFX.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.fluidFX != null) {
            int fluidFXSize = 0;
            for (var kvp : this.fluidFX.entrySet()) {
    ...
    public UpdateFluidFX clone() {
        ...
        if (this.fluidFX != null) {
            HashMap<Integer, FluidFX> m = new HashMap<Integer, FluidFX>();
            for (var e : this.fluidFX.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateFluidFX)) {
            return false;
        }
        UpdateFluidFX other = (UpdateFluidFX)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && this.maxId == other.maxId && Objects.equals(this.fluidFX, other.fluidFX);
    }
