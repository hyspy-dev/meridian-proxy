...
ToClientPacket {
    ...
    public static UpdateItemSoundSets deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            obj.itemSoundSets = new HashMap<Integer, ItemSoundSet>(itemSoundSetsCount);
            for (int i = 0; i < itemSoundSetsCount; ++i) {
                int key = buf.getIntLE(pos);
                ItemSoundSet val = ItemSoundSet.deserialize(buf, pos += 4);
                pos += ItemSoundSet.computeBytesConsumed(buf, pos);
                if (obj.itemSoundSets.put(key, val) == null) continue;
    ...
    public int computeSize() {
        ...
        if (this.itemSoundSets != null) {
            ...
            for (var kvp : this.itemSoundSets.entrySet()) {
    ...
    public UpdateItemSoundSets clone() {
        ...
        if (this.itemSoundSets != null) {
            HashMap<Integer, ItemSoundSet> m = new HashMap<Integer, ItemSoundSet>();
            for (var e : this.itemSoundSets.entrySet()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof UpdateItemSoundSets)) {
            return false;
        }
        UpdateItemSoundSets other = (UpdateItemSoundSets)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && this.maxId == other.maxId && Objects.equals(this.itemSoundSets, other.itemSoundSets);
    }
