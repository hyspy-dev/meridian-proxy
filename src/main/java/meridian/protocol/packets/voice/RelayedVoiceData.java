...
ToClientPacket {
    ...
    public RelayedVoiceData(@Nonnull UUID speakerId, int entityId, short sequenceNumber, int timestamp, @Nullable Position speakerPosition, boolean speakerIsUnderwater, @Nonnull byte[] opusData) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof RelayedVoiceData)) {
            return false;
        }
        RelayedVoiceData other = (RelayedVoiceData)obj;
        return Objects.equals(this.speakerId, other.speakerId) && this.entityId == other.entityId && this.sequenceNumber == other.sequenceNumber && this.timestamp == other.timestamp && Objects.equals(this.speakerPosition, other.speakerPosition) && this.speakerIsUnderwater == other.speakerIsUnderwater && Arrays.equals(this.opusData, other.opusData);
    }
