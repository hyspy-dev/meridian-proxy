...
import meridian.protocol.packets.voice.VoiceCodec;
...
ToClientPacket {
    ...
    public boolean equals(Object obj) {
        ...
        return this.voiceEnabled == other.voiceEnabled && Objects.equals((Object)this.codec, (Object)other.codec) && this.sampleRate == other.sampleRate && this.channels == other.channels && this.maxHearingDistance == other.maxHearingDistance && this.referenceDistance == other.referenceDistance && this.supportsVoiceStream == other.supportsVoiceStream && this.maxPacketsPerSecond == other.maxPacketsPerSecond;
    }

    public int hashCode() {
        return Objects.hash(new Object[]{this.voiceEnabled, this.codec, this.sampleRate, this.channels, Float.valueOf(this.maxHearingDistance), Float.valueOf(this.referenceDistance), this.supportsVoiceStream, this.maxPacketsPerSecond});
    }
}
