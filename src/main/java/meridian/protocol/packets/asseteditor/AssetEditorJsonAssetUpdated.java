...
import meridian.protocol.packets.asseteditor.JsonUpdateCommand;
...
ToClientPacket {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorJsonAssetUpdated)) {
            return false;
        }
