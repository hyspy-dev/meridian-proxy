...
import meridian.protocol.packets.asseteditor.AssetEditorPopupNotificationType;
...
ToClientPacket {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorPopupNotification)) {
            return false;
        }
        AssetEditorPopupNotification other = (AssetEditorPopupNotification)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && Objects.equals(this.message, other.message);
    }
