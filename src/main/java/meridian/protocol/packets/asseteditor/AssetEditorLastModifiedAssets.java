...
import meridian.protocol.packets.asseteditor.AssetInfo;
...
ToClientPacket {
    ...
    public AssetEditorLastModifiedAssets clone() {
        ...
        copy.assets = this.assets != null ? (AssetInfo[])Arrays.stream(this.assets).map(e -> e.clone()).toArray(AssetInfo[]::new) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorLastModifiedAssets)) {
            return false;
        }
