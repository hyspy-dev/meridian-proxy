...
ToClientPacket {
    ...
    public AssetEditorExportDeleteAssets clone() {
        ...
        copy.asset = this.asset != null ? (AssetEditorAsset[])Arrays.stream(this.asset).map(e -> e.clone()).toArray(AssetEditorAsset[]::new) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorExportDeleteAssets)) {
            return false;
        }
