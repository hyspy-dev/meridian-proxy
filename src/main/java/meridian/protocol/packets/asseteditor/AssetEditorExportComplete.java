...
import meridian.protocol.packets.asseteditor.TimestampedAssetReference;
...
ToClientPacket {
    ...
    public AssetEditorExportComplete clone() {
        ...
        copy.assets = this.assets != null ? (TimestampedAssetReference[])Arrays.stream(this.assets).map(e -> e.clone()).toArray(TimestampedAssetReference[]::new) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AssetEditorExportComplete)) {
            return false;
        }
