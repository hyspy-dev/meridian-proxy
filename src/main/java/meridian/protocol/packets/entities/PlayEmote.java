...
ToServerPacket {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            if ((pos += emoteIdLen) > buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof PlayEmote)) {
            return false;
        }
        PlayEmote other = (PlayEmote)obj;
        return Objects.equals(this.emoteId, other.emoteId);
    }
