...
ToClientPacket {
    ...
    public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 4) != 0) {
            ...
            if ((pos2 += ExtraResources.computeBytesConsumed(buf, pos2)) - offset > maxEnd) {
                maxEnd = pos2 - offset;
            }
        }
        return maxEnd;
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            pos = offset + 18 + windowDataOffset;
            ...
            if ((pos += windowDataLen) > buffer.writerIndex()) {
        ...
        if ((nullBits & 4) != 0) {
            ...
            pos = offset + 18 + extraResourcesOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OpenWindow)) {
            return false;
        }
        OpenWindow other = (OpenWindow)obj;
        return this.id == other.id && Objects.equals((Object)this.windowType, (Object)other.windowType) && Objects.equals(this.windowData, other.windowData) && Objects.equals(this.inventory, other.inventory) && Objects.equals(this.extraResources, other.extraResources);
    }
