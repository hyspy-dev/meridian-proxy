...
ToClientPacket {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            if ((pos += rejectionReasonLen) > buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof StreamOpenResponse)) {
            return false;
        }
        StreamOpenResponse other = (StreamOpenResponse)obj;
        return Objects.equals((Object)this.type, (Object)other.type) && this.accepted == other.accepted && Objects.equals(this.rejectionReason, other.rejectionReason);
    }

    public int hashCode() {
        return Objects.hash(new Object[]{this.type, this.accepted, this.rejectionReason});
    }
}
