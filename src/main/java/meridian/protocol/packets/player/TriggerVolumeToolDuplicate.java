...
public class TriggerVolumeToolDuplicate implements Packet, ToServerPacket {
   ...
   @Nonnull
   public static TriggerVolumeToolDuplicate deserialize(@Nonnull ByteBuf buf, int offset) {
      TriggerVolumeToolDuplicate obj = new TriggerVolumeToolDuplicate();
      int pos = offset + 0;
   ...
   public static TriggerVolumeToolDuplicate toObject(MemorySegment mem, int offset) {
      if (offset + 0 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("TriggerVolumeToolDuplicate", offset + 0, (int)mem.byteSize());
      }
      ...
      return new TriggerVolumeToolDuplicate(volumeIds);
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof TriggerVolumeToolDuplicate other ? Arrays.equals(this.volumeIds, other.volumeIds) : false;
      }
   }
