...
import meridian.protocol.packets.buildertools.BuilderToolArgType;
import meridian.protocol.packets.buildertools.BuilderToolBlockArg;
import meridian.protocol.packets.buildertools.BuilderToolBoolArg;
import meridian.protocol.packets.buildertools.BuilderToolBrushAxisArg;
import meridian.protocol.packets.buildertools.BuilderToolBrushOriginArg;
import meridian.protocol.packets.buildertools.BuilderToolBrushShapeArg;
import meridian.protocol.packets.buildertools.BuilderToolFloatArg;
import meridian.protocol.packets.buildertools.BuilderToolIntArg;
import meridian.protocol.packets.buildertools.BuilderToolMaskArg;
import meridian.protocol.packets.buildertools.BuilderToolOptionArg;
import meridian.protocol.packets.buildertools.BuilderToolRotationArg;
import meridian.protocol.packets.buildertools.BuilderToolStringArg;
...
public class BuilderToolArg {
    ...
    public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits[1] & 1) != 0) {
            ...
            if ((pos1 += BuilderToolStringArg.computeBytesConsumed(buf, pos1)) - offset > maxEnd) {
                maxEnd = pos1 - offset;
            }
        }
        if ((nullBits[1] & 2) != 0) {
            ...
            if ((pos2 += BuilderToolBlockArg.computeBytesConsumed(buf, pos2)) - offset > maxEnd) {
                maxEnd = pos2 - offset;
            }
        }
        if ((nullBits[1] & 4) != 0) {
        ...
        if ((nullBits[1] & 8) != 0) {
            ...
            if ((pos4 += BuilderToolOptionArg.computeBytesConsumed(buf, pos4)) - offset > maxEnd) {
                maxEnd = pos4 - offset;
            }
        }
        return maxEnd;
