...
public class ClipboardEntityChange {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ClipboardEntityChange)) {
            return false;
        }
        ClipboardEntityChange other = (ClipboardEntityChange)obj;
        return this.x == other.x && this.y == other.y && this.z == other.z && this.blockId == other.blockId && Objects.equals(this.model, other.model) && Objects.equals(this.itemId, other.itemId) && Objects.equals(this.bodyOrientation, other.bodyOrientation) && Objects.equals(this.lookOrientation, other.lookOrientation) && this.scale == other.scale;
    }

    public int hashCode() {
        return Objects.hash(Float.valueOf(this.x), Float.valueOf(this.y), Float.valueOf(this.z), this.blockId, this.model, this.itemId, this.bodyOrientation, this.lookOrientation, Float.valueOf(this.scale));
    }
}
