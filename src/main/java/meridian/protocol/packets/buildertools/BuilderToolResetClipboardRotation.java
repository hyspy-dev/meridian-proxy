...
public class BuilderToolResetClipboardRotation
implements Packet,
ToServerPacket {
    ...
    public static BuilderToolResetClipboardRotation deserialize(@Nonnull ByteBuf buf, int offset) {
        BuilderToolResetClipboardRotation obj = new BuilderToolResetClipboardRotation();
        return obj;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof BuilderToolResetClipboardRotation)) {
            return false;
        }
        BuilderToolResetClipboardRotation other = (BuilderToolResetClipboardRotation)obj;
        return true;
    }
