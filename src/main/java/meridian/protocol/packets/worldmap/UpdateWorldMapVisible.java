...
public class UpdateWorldMapVisible implements Packet, ToServerPacket {
   ...
   public static UpdateWorldMapVisible toObject(MemorySegment mem, int offset) {
      if (offset + 1 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("UpdateWorldMapVisible", offset + 1, (int)mem.byteSize());
      } else {
         return new UpdateWorldMapVisible(mem.get(PacketIO.PROTO_BOOL, offset + 0));
      }
   }
