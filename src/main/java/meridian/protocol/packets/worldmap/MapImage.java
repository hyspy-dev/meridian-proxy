...
public class MapImage {
    ...
    public static MapImage deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            if ((long)(varPos0 + varIntLen) + (long)paletteCount * 4L > (long)buf.readableBytes()) {
        ...
        if ((nullBits & 2) != 0) {
            ...
            if ((long)(varPos1 + varIntLen) + (long)packedIndicesCount * 1L > (long)buf.readableBytes()) {
            ...
            for (i = 0; i < packedIndicesCount; ++i) {
    ...
    public void serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.packedIndices != null) {
            ...
            for (int item : this.packedIndices) {
                buf.writeByte(item);
            }
        } else {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 1) != 0) {
            ...
            if ((pos += paletteCount * 4) > buffer.writerIndex()) {
        ...
        if ((nullBits & 2) != 0) {
            ...
            pos = offset + 18 + packedIndicesOffset;
            if (pos >= buffer.writerIndex()) {
            ...
            pos += VarInt.length(buffer, pos);
            if ((pos += packedIndicesCount * 1) > buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.width == other.width && this.height == other.height && Arrays.equals(this.palette, other.palette) && this.bitsPerIndex == other.bitsPerIndex && Arrays.equals(this.packedIndices, other.packedIndices);
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + Arrays.hashCode(this.packedIndices);
        return result;
    }
}
