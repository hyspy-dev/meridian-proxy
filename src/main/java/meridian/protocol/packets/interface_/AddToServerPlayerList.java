...
import meridian.protocol.packets.interface_.ServerPlayerListPlayer;
...
ToClientPacket {
    ...
    public AddToServerPlayerList clone() {
        ...
        copy.players = this.players != null ? (ServerPlayerListPlayer[])Arrays.stream(this.players).map(e -> e.clone()).toArray(ServerPlayerListPlayer[]::new) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AddToServerPlayerList)) {
            return false;
        }
