...
public class MovementSettings {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MovementSettings)) {
            return false;
        }
    ...
    public int hashCode() {
        return Objects.hash(Float.valueOf(this.mass), Float.valueOf(this.dragCoefficient), this.invertedGravity, Float.valueOf(this.velocityResistance), Float.valueOf(this.jumpForce), Float.valueOf(this.swimJumpForce), Float.valueOf(this.jumpBufferDuration), Float.valueOf(this.jumpBufferMaxYVelocity), Float.valueOf(this.acceleration), Float.valueOf(this.airDragMin), Float.valueOf(this.airDragMax), Float.valueOf(this.airDragMinSpeed), Float.valueOf(this.airDragMaxSpeed), Float.valueOf(this.airFrictionMin), Float.valueOf(this.airFrictionMax), Float.valueOf(this.airFrictionMinSpeed), Float.valueOf(this.airFrictionMaxSpeed), Float.valueOf(this.airSpeedMultiplier), Float.valueOf(this.airControlMinSpeed), Float.valueOf(this.airControlMaxSpeed), Float.valueOf(this.airControlMinMultiplier), Float.valueOf(this.airControlMaxMultiplier), Float.valueOf(this.comboAirSpeedMultiplier), Float.valueOf(this.baseSpeed), Float.valueOf(this.climbSpeed), Float.valueOf(this.climbSpeedLateral), Float.valueOf(this.climbUpSprintSpeed), Float.valueOf(this.climbDownSprintSpeed), Float.valueOf(this.horizontalFlySpeed), Float.valueOf(this.verticalFlySpeed), Float.valueOf(this.maxSpeedMultiplier), Float.valueOf(this.minSpeedMultiplier), Float.valueOf(this.wishDirectionGravityX), Float.valueOf(this.wishDirectionGravityY), Float.valueOf(this.wishDirectionWeightX), Float.valueOf(this.wishDirectionWeightY), this.canFly, Float.valueOf(this.collisionExpulsionForce), Float.valueOf(this.forwardWalkSpeedMultiplier), Float.valueOf(this.backwardWalkSpeedMultiplier), Float.valueOf(this.strafeWalkSpeedMultiplier), Float.valueOf(this.forwardRunSpeedMultiplier), Float.valueOf(this.backwardRunSpeedMultiplier), Float.valueOf(this.strafeRunSpeedMultiplier), Float.valueOf(this.forwardCrouchSpeedMultiplier), Float.valueOf(this.backwardCrouchSpeedMultiplier), Float.valueOf(this.strafeCrouchSpeedMultiplier), Float.valueOf(this.forwardSprintSpeedMultiplier), Float.valueOf(this.variableJumpFallForce), Float.valueOf(this.fallEffectDuration), Float.valueOf(this.fallJumpForce), Float.valueOf(this.fallMomentumLoss), Float.valueOf(this.autoJumpObstacleSpeedLoss), Float.valueOf(this.autoJumpObstacleSprintSpeedLoss), Float.valueOf(this.autoJumpObstacleEffectDuration), Float.valueOf(this.autoJumpObstacleSprintEffectDuration), Float.valueOf(this.autoJumpObstacleMaxAngle), this.autoJumpDisableJumping, Float.valueOf(this.minSlideEntrySpeed), Float.valueOf(this.slideExitSpeed), Float.valueOf(this.minFallSpeedToEngageRoll), Float.valueOf(this.maxFallSpeedToEngageRoll), Float.valueOf(this.rollStartSpeedModifier), Float.valueOf(this.rollExitSpeedModifier), Float.valueOf(this.rollTimeToComplete));
    }
}
