...
public class FirstClickInteraction extends Interaction {
   ...
   public static FirstClickInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 39) {
         throw ProtocolException.bufferTooSmall("FirstClickInteraction", 39, buf.readableBytes() - offset);
      }
   ...
   public static InteractionEffects getEffects(MemorySegment mem, int offset) {
      return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 19, 39, "Effects")) : null;
   }
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 23, 39, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 27, 39, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 31, 39, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
      return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 35, 39, "Camera")) : null;
   }
   ...
   public static FirstClickInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 39 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("FirstClickInteraction", offset + 39, (int)mem.byteSize());
      }
      ...
      return new FirstClickInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 19, 39, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 27, 39, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 35, 39, "Camera")) : null,
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_INT, offset + 11, this.click);
      mem.set(PacketIO.PROTO_INT, offset + 15, this.held);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof FirstClickInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Integer.hashCode(this.held);
   }
}
