...
public class ParticleAttractor {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ParticleAttractor)) {
            return false;
        }
