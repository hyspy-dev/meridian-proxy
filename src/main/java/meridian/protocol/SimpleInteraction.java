...
public class SimpleInteraction extends Interaction {
   ...
   public static SimpleInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 39) {
         throw ProtocolException.bufferTooSmall("SimpleInteraction", 39, buf.readableBytes() - offset);
      }
   ...
   public static SimpleInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 39 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("SimpleInteraction", offset + 39, (int)mem.byteSize());
      }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof SimpleInteraction other)
            ? false
