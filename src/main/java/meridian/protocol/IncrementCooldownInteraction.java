...
public class IncrementCooldownInteraction extends SimpleInteraction {
   ...
   public static InteractionEffects getEffects(MemorySegment mem, int offset) {
      return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 32, 56, "Effects")) : null;
   }
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 36, 56, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 40, 56, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 44, 56, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
      return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 48, 56, "Camera")) : null;
   }
   ...
   public static String getCooldownId(MemorySegment mem, int offset) {
      return hasCooldownId(mem, offset)
         ? PacketIO.readVarString("CooldownId", mem, offset + getValidatedOffset(mem, offset, 52, 56, "CooldownId"), 4096000, PacketIO.UTF8)
         : null;
   }
   ...
   public static boolean getCooldownIncrementInterrupt(MemorySegment mem, int offset) {
      return mem.get(PacketIO.PROTO_BOOL, offset + 31);
   }
   ...
   public static IncrementCooldownInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 56 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("IncrementCooldownInteraction", offset + 56, (int)mem.byteSize());
      }
      ...
      return new IncrementCooldownInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 32, 56, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 40, 56, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 48, 56, "Camera")) : null,
         ...
         mem.get(PacketIO.PROTO_BOOL, offset + 31)
      );
   }
   ...
   public int serialize(@Nonnull MemorySegment mem, int offset) {
      ...
      mem.set(PacketIO.PROTO_FLOAT, offset + 19, this.cooldownIncrementTime);
      mem.set(PacketIO.PROTO_INT, offset + 23, this.cooldownIncrementCharge);
      mem.set(PacketIO.PROTO_FLOAT, offset + 27, this.cooldownIncrementChargeTime);
      mem.set(PacketIO.PROTO_BOOL, offset + 31, this.cooldownIncrementInterrupt);
      int varOffset = offset + 56;
      if (this.effects != null) {
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof IncrementCooldownInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Boolean.hashCode(this.cooldownIncrementInterrupt);
   }
}
