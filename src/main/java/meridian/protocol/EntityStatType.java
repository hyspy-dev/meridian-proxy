...
import meridian.protocol.EntityStatEffects;
import meridian.protocol.EntityStatResetBehavior;
...
public class EntityStatType {
    ...
    public static EntityStatType deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        boolean bl = obj.hideFromTooltip = buf.getByte(offset + 14) != 0;
        if ((nullBits & 1) != 0) {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 2) != 0) {
            ...
            pos = offset + 27 + minValueEffectsOffset;
            if (pos >= buffer.writerIndex()) {
        ...
        if ((nullBits & 4) != 0) {
            ...
            pos = offset + 27 + maxValueEffectsOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.id, other.id) && this.value == other.value && this.min == other.min && this.max == other.max && Objects.equals(this.minValueEffects, other.minValueEffects) && Objects.equals(this.maxValueEffects, other.maxValueEffects) && Objects.equals((Object)this.resetBehavior, (Object)other.resetBehavior) && this.hideFromTooltip == other.hideFromTooltip;
    }

    public int hashCode() {
        return Objects.hash(new Object[]{this.id, Float.valueOf(this.value), Float.valueOf(this.min), Float.valueOf(this.max), this.minValueEffects, this.maxValueEffects, this.resetBehavior, this.hideFromTooltip});
    }
}
