...
import meridian.protocol.ItemSoundEvent;
...
public class ItemSoundSet {
    ...
    public static ItemSoundSet deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        if ((nullBits & 2) != 0) {
            ...
            obj.soundEventIndices = new HashMap<ItemSoundEvent, Integer>(soundEventIndicesCount);
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((nullBits & 2) != 0) {
            ...
            pos = offset + 9 + soundEventIndicesOffset;
            if (pos >= buffer.writerIndex()) {
    ...
    public ItemSoundSet clone() {
        ...
        copy.id = this.id;
        copy.soundEventIndices = this.soundEventIndices != null ? new HashMap<ItemSoundEvent, Integer>(this.soundEventIndices) : null;
        return copy;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ItemSoundSet)) {
            return false;
        }
