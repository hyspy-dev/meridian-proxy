...
import meridian.protocol.BenchTierLevel;
...
public class Bench {
    ...
    public Bench clone() {
        ...
        copy.benchTierLevels = this.benchTierLevels != null ? (BenchTierLevel[])Arrays.stream(this.benchTierLevels).map(e -> e.clone()).toArray(BenchTierLevel[]::new) : null;
        return copy;
    }
