...
public class FormattedMessageImage {
    ...
    public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
        ...
        if ((pos += filePathLen) > buffer.writerIndex()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof FormattedMessageImage)) {
            return false;
        }
        FormattedMessageImage other = (FormattedMessageImage)obj;
        return Objects.equals(this.filePath, other.filePath) && this.width == other.width && this.height == other.height;
    }
