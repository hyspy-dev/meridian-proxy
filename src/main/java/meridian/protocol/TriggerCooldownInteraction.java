...
public class TriggerCooldownInteraction extends SimpleInteraction {
   ...
   public static TriggerCooldownInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 43) {
         throw ProtocolException.bufferTooSmall("TriggerCooldownInteraction", 43, buf.readableBytes() - offset);
      }
      ...
      if ((nullBits & 32) != 0) {
         ...
         if (varPosBase5 < 0 || varPosBase5 > buf.writerIndex() - offset - 43) {
            throw ProtocolException.invalidOffset("Cooldown", varPosBase5, buf.readableBytes());
         }
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         if (fieldOffset5 < 0 || fieldOffset5 > buf.writerIndex() - offset - 43) {
            throw ProtocolException.invalidOffset("Cooldown", fieldOffset5, maxEnd);
         }
   ...
   public static InteractionCooldown getCooldown(MemorySegment mem, int offset) {
      return hasCooldown(mem, offset) ? InteractionCooldown.toObject(mem, offset + getValidatedOffset(mem, offset, 39, 43, "Cooldown")) : null;
   }
   ...
   public static TriggerCooldownInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 43 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("TriggerCooldownInteraction", offset + 43, (int)mem.byteSize());
      }
      ...
      return new TriggerCooldownInteraction(
         ...
         hasCooldown(mem, offset) ? InteractionCooldown.toObject(mem, offset + getValidatedOffset(mem, offset, 39, 43, "Cooldown")) : null
      );
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof TriggerCooldownInteraction other)
            ? false
   ...
   public int hashCode() {
      ...
      return 31 * result + Objects.hashCode(this.cooldown);
   }
}
