...
public class ProtocolEmote {
    ...
    public static ProtocolEmote deserialize(@Nonnull ByteBuf buf, int offset) {
        ...
        boolean bl = obj.isLooping = buf.getByte(offset + 1) != 0;
        if ((nullBits & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProtocolEmote)) {
            return false;
        }
        ProtocolEmote other = (ProtocolEmote)obj;
        return Objects.equals(this.id, other.id) && Objects.equals(this.name, other.name) && Objects.equals(this.animation, other.animation) && Objects.equals(this.icon, other.icon) && this.isLooping == other.isLooping;
    }
