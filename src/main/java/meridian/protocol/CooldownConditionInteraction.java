...
public class CooldownConditionInteraction extends SimpleInteraction {
   ...
   public static String getCooldownId(MemorySegment mem, int offset) {
      return hasCooldownId(mem, offset)
         ? PacketIO.readVarString("CooldownId", mem, offset + getValidatedOffset(mem, offset, 39, 43, "CooldownId"), 4096000, PacketIO.UTF8)
         : null;
   }
   ...
   public static CooldownConditionInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 43 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("CooldownConditionInteraction", offset + 43, (int)mem.byteSize());
      }
      ...
      return new CooldownConditionInteraction(
