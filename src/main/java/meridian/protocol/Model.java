...
import meridian.protocol.AnimationSet;
import meridian.protocol.CameraSettings;
import meridian.protocol.ColorLight;
import meridian.protocol.DetailBox;
import meridian.protocol.Hitbox;
import meridian.protocol.ModelAttachment;
import meridian.protocol.ModelParticle;
import meridian.protocol.ModelTrail;
import meridian.protocol.Phobia;
...
public class Model {
    ...
    public void serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.animationSets != null) {
            ...
            for (var entry : this.animationSets.entrySet()) {
        ...
        if (this.detailBoxes != null) {
            ...
            for (var entry : this.detailBoxes.entrySet()) {
    ...
    public Model clone() {
        ...
        if (this.animationSets != null) {
            HashMap<String, AnimationSet> m = new HashMap<>();
            for (var entry : this.animationSets.entrySet()) {
        ...
        if (this.detailBoxes != null) {
            HashMap<String, DetailBox[]> m = new HashMap<>();
            for (var entry : this.detailBoxes.entrySet()) {
                m.put(entry.getKey(), (DetailBox[])Arrays.stream(entry.getValue()).map(x -> x.clone()).toArray(DetailBox[]::new));
            }
            copy.detailBoxes = m;
        }
