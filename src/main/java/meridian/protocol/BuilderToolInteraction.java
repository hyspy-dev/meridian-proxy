...
public class BuilderToolInteraction extends SimpleInteraction {
   ...
   public static BuilderToolInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 39) {
         throw ProtocolException.bufferTooSmall("BuilderToolInteraction", 39, buf.readableBytes() - offset);
      }
   ...
   public static BuilderToolInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 39 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("BuilderToolInteraction", offset + 39, (int)mem.byteSize());
      }
      ...
      return new BuilderToolInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof BuilderToolInteraction other)
            ? false
