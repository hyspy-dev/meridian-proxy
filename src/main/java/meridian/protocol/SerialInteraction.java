...
public class SerialInteraction extends Interaction {
   ...
   public SerialInteraction(
      ...
      @Nullable int[] serialInteractions
   ) {
   ...
   public static SerialInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 35) {
         throw ProtocolException.bufferTooSmall("SerialInteraction", 35, buf.readableBytes() - offset);
      }
      ...
      if ((nullBits & 8) != 0) {
         int varPosBase3 = buf.getIntLE(offset + 23);
      ...
      if ((nullBits & 16) != 0) {
         int varPosBase4 = buf.getIntLE(offset + 27);
      ...
      if ((nullBits & 32) != 0) {
         int varPosBase5 = buf.getIntLE(offset + 31);
         if (varPosBase5 < 0 || varPosBase5 > buf.writerIndex() - offset - 35) {
            throw ProtocolException.invalidOffset("SerialInteractions", varPosBase5, buf.readableBytes());
         }

         int varPos5 = offset + 35 + varPosBase5;
         int serialInteractionsCount = VarInt.peek(buf, varPos5);
         if (serialInteractionsCount < 0) {
            throw ProtocolException.invalidVarInt("SerialInteractions");
         }

         int varIntLen = VarInt.size(serialInteractionsCount);
         ...
         if (varPos5 + varIntLen + serialInteractionsCount * 4L > buf.readableBytes()) {
   ...
   public static int computeBytesConsumed(@Nonnull ByteBuf buf, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         if (fieldOffset5 < 0 || fieldOffset5 > buf.writerIndex() - offset - 35) {
            throw ProtocolException.invalidOffset("SerialInteractions", fieldOffset5, maxEnd);
         }
   ...
   public static InteractionEffects getEffects(MemorySegment mem, int offset) {
      return hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 11, 35, "Effects")) : null;
   }
   ...
   public static Map<GameMode, InteractionSettings> getSettings(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 15, 35, "Settings");
   ...
   public static InteractionRules getRules(MemorySegment mem, int offset) {
      return hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 19, 35, "Rules")) : null;
   }
   ...
   public static int[] getTags(MemorySegment mem, int offset) {
      ...
      int off = offset + getValidatedOffset(mem, offset, 23, 35, "Tags");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
   ...
   public static InteractionCameraSettings getCamera(MemorySegment mem, int offset) {
      return hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 27, 35, "Camera")) : null;
   }
   ...
   public static int[] getSerialInteractions(MemorySegment mem, int offset) {
      if (!hasSerialInteractions(mem, offset)) {
         return null;
      }

      int off = offset + getValidatedOffset(mem, offset, 31, 35, "SerialInteractions");
      long packed = VarInt.getWithLength(mem, off);
      int len = (int)packed;
      if (len < 0) {
         throw ProtocolException.negativeLength("SerialInteractions", len);
      }

      if (len > 4096000) {
         throw ProtocolException.arrayTooLong("SerialInteractions", len, 4096000);
      }

      int lenOffset = (int)(packed >>> 32);
      if (off + lenOffset + len * 4L > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("SerialInteractions", off + lenOffset + len * 4, (int)mem.byteSize());
      }
   ...
   public static boolean hasSerialInteractions(MemorySegment mem, int offset) {
      byte b = mem.get(PacketIO.PROTO_BYTE, offset + 0);
      return (b & 32) != 0;
   }
   ...
   public static SerialInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 35 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("SerialInteraction", offset + 35, (int)mem.byteSize());
      }
      ...
      if (hasSerialInteractions(mem, offset)) {
         ...
         off += lenOffset;
         serialInteractions = new int[len];
         MemorySegment.copy(mem, PacketIO.PROTO_INT, off, serialInteractions, 0, len);
      }

      return new SerialInteraction(
         WaitForDataFrom.fromValue(mem.get(PacketIO.PROTO_BYTE, offset + 1)),
         hasEffects(mem, offset) ? InteractionEffects.toObject(mem, offset + getValidatedOffset(mem, offset, 11, 35, "Effects")) : null,
         mem.get(PacketIO.PROTO_FLOAT, offset + 2),
         mem.get(PacketIO.PROTO_FLOAT, offset + 6),
         mem.get(PacketIO.PROTO_BOOL, offset + 10),
         settings,
         hasRules(mem, offset) ? InteractionRules.toObject(mem, offset + getValidatedOffset(mem, offset, 19, 35, "Rules")) : null,
         tags,
         hasCamera(mem, offset) ? InteractionCameraSettings.toObject(mem, offset + getValidatedOffset(mem, offset, 27, 35, "Camera")) : null,
         serialInteractions
      );
   }
   ...
   public static ValidationResult validateStructure(@Nonnull ByteBuf buffer, int offset) {
      ...
      if ((nullBits & 32) != 0) {
         ...
         pos += VarInt.size(serialInteractionsCount);
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof SerialInteraction other)
            ? false
            : Objects.equals(this.waitForDataFrom, other.waitForDataFrom)
               ...
               && Arrays.equals(this.serialInteractions, other.serialInteractions);
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * result + Arrays.hashCode(this.serialInteractions);
   }
}
