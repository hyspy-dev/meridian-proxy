...
public class ToggleGliderInteraction extends SimpleInteraction {
   ...
   public static ToggleGliderInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 39) {
         throw ProtocolException.bufferTooSmall("ToggleGliderInteraction", 39, buf.readableBytes() - offset);
      }
   ...
   public static ToggleGliderInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 39 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("ToggleGliderInteraction", offset + 39, (int)mem.byteSize());
      }
      ...
      return new ToggleGliderInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof ToggleGliderInteraction other)
            ? false
