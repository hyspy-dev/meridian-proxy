...
import meridian.protocol.ItemReticle;
import meridian.protocol.ItemReticleClientEvent;
...
public class ItemReticleConfig {
    ...
    public void serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.serverEvents != null) {
            ...
            for (var entry : this.serverEvents.entrySet()) {
        ...
        if (this.clientEvents != null) {
            ...
            for (var entry : this.clientEvents.entrySet()) {
    ...
    public ItemReticleConfig clone() {
        ...
        if (this.serverEvents != null) {
            HashMap<Integer, ItemReticle> m = new HashMap<>();
            for (var entry : this.serverEvents.entrySet()) {
        ...
        if (this.clientEvents != null) {
            HashMap<ItemReticleClientEvent, ItemReticle> m = new HashMap<>();
            for (var entry : this.clientEvents.entrySet()) {
                m.put(entry.getKey(), entry.getValue().clone());
            }
            copy.clientEvents = m;
