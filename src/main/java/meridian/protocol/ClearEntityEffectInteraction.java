...
public class ClearEntityEffectInteraction extends SimpleInteraction {
   ...
   public static ClearEntityEffectInteraction deserialize(@Nonnull ByteBuf buf, int offset) {
      if (buf.readableBytes() - offset < 44) {
         throw ProtocolException.bufferTooSmall("ClearEntityEffectInteraction", 44, buf.readableBytes() - offset);
      }
   ...
   public static ClearEntityEffectInteraction toObject(MemorySegment mem, int offset) {
      if (offset + 44 > mem.byteSize()) {
         throw ProtocolException.bufferTooSmall("ClearEntityEffectInteraction", offset + 44, (int)mem.byteSize());
      }
      ...
      return new ClearEntityEffectInteraction(
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return !(obj instanceof ClearEntityEffectInteraction other)
            ? false
