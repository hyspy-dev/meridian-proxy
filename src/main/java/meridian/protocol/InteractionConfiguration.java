...
import meridian.protocol.InteractionPriority;
...
public class InteractionConfiguration {
    ...
    public void serialize(@Nonnull ByteBuf buf) {
        ...
        if (this.useDistance != null) {
            ...
            for (var entry : this.useDistance.entrySet()) {
        ...
        if (this.priorities != null) {
            ...
            for (var entry : this.priorities.entrySet()) {
                buf.writeByte(((InteractionType)entry.getKey()).getValue());
                ((InteractionPriority)entry.getValue()).serialize(buf);
            }
        } else {
    ...
    public int computeSize() {
        ...
        if (this.priorities != null) {
            ...
            for (var kvp : this.priorities.entrySet()) {
